...
class AthletesList extends Component {
    ...
    add({id = null,lastName = "test",firstName = "test",age,countryCode,sportTypes}) {
        ...
        {
            array.push("Type of sport: ");
            array.push(sportTypes[i].type);
            array.push(" Year started: ");
            array.push(sportTypes[i].startYear);
            array.push(" Times won: ");
            array.push(sportTypes[i].victoryNum);
    ...
    eachAthlete(item, i) {
        return (
            <div
                ...
                className="card"
                style={ { width: '33%', marginBottom: '7px' } }
            >
